...
var v = new Vue({
   el:'#app',
    ...
    methods:{
         showAll(){ axios.get(this.url+"AppControl/showAll").then(function(response){
        ...
        updateUser(){
            var formData = v.formData(v.chooseUser); axios.post(this.url+"AppControl/updateUser", formData).then(function(response){
                if(response.data.error){
                    v.formValidate = response.data.msg;
                }else{
